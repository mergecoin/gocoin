...
func main() {
	...
	weight, err := functions.Determine("ventureharbour", "ventureharbour.com", "xxxxx", 43, 1, []byte(`{"split": {"contribute": "60","review": "40"}, "ignored": {"ignored": ["assets/html", "build", "package-lock.json"]}}`))
